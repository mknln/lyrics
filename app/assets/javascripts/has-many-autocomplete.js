    ...
    init: function(e) {
      ...
      $(e).autocomplete({
        ...
        select: function( event, ui ) {
          e.list_element.append('<li class="ui-state-default"><span class="ui-icon ui-icon-arrowthick-2-n-s">&nbsp;</span><a href="#" class="hma-remove-link" data-id="'+ui.item.id+'"><span class="hma-remove-link-text">Remove</a> <span class="hma-item-label">'+ui.item.label+'</span></li>');
